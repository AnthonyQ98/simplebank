...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a\x16rpc_verify_email.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xe6\x04\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"I\x92A,\x12\vUpdate user\x1a\x1dUse this API to update a user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\xa6\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"l\x92AP\x12\rLogin to user\x1a?Use this API to login user & get access token and refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x94\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"T\x92A9\x12\fVerify email\x1a)Use this API to verify user email address\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x92\x01\x92Aj\x12h\n" +
	"\x0fSimple Bank API\"P\n" +
	"\rAnthony Quinn\x12\x1dhttps://github.com/AnthonyQ98\x1a anthonyquinn.developer@gmail.com2\x031.1Z#github.com/anthonyq98/simplebank/pbb\x06proto3"
